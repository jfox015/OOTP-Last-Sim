                ...
                <div class="mod-content">
                    ...
                    <?php
                        ...
                        foreach($performers as $row) :
                            ...
                            if (file_exists($settings['ootp.players_img_path'].'player_'.$row['player_id'].'.png')) {
                                $player_img = $settings['ootp.players_img_url'].'player_'.$row['player_id'].'.png';
                            } else {
                                $player_img = $settings['ootp.asset_url'].'images/default_player_photo.png';
                            }

                            ?>
                            <li class="<?php echo($rownum==1 ? 'first':'alt');?> leader">
                            <a href="<?php echo($settings['ootp.asset_url']);?>players/player_<?php echo($row['player_id']);?>.html"><img
                                src="<?php echo($player_img);?>" border="0" width="35" height="48" alt="" title="" /></a>
                            <ul class="top-performers">
                                <li><a href="<?php echo($settings['ootp.asset_url']);?>players/player_<?php echo($row['player_id']);?>.html"><strong><?php echo($row['first_name'] . " " . $row['last_name']);?></strong></a>
                                    &nbsp;&nbsp;<a href="<?php echo($settings['ootp.asset_url']);?>teams/team_<?php echo($tid);?>.html"><?php echo($teams[$tid]['abbr']); ?></a></li>
