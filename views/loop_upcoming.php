				...
				foreach($upcoming as $row) {
					...
					<tr>
						...
						<tr>
							...
							<img src="<?php echo($settings['osp.team_logo_url'].str_replace(".png","_40.png",$teams[$aid]['logo_file']));?>" width="40" height="40"><br />
							<img src="<?php echo($settings['osp.team_logo_url'].str_replace(".png","_40.png",$teams[$hid]['logo_file']));?>" width="40" height="40"><br />
							</td>
							...
							<tr>
								<td class='gl'><a href="<?php echo($settings['osp.asset_url'].'teams/team_'.$aid); ?>.html"><?php echo($teams[$aid]['name']); ?></a></td>
								<?php
							...
							<tr>
								<td class='gl'><a href="<?php echo($settings['osp.asset_url'].'teams/team_'.$hid); ?>.html"><?php echo($teams[$hid]['name']); ?></a></td>
								<?php
